...
This repository contains the official, fully reproducible R replication framework for the manuscript **"Beyond Varimax: Algorithmic Stability and Variance Redistribution in Orthogonal Component Rotation"**. 
...
│   └── MASTER_scenario_winner_download.rds # Raw simulation winner logs (from TRUBA HPC outputs)
